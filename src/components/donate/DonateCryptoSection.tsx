    ...
    >
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="absolute top-0 left-1/4 w-px h-full bg-[#2a4f32]"></div>
          <div className="absolute top-0 left-1/2 w-px h-full bg-[#2a4f32]"></div>
          <div className="absolute top-0 left-3/4 w-px h-full bg-[#2a4f32]"></div>
        </div>
        {/* Horizontal lines */}
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="absolute top-1/4 left-0 w-full h-px bg-[#2a4f32]"></div>
          <div className="absolute top-1/2 left-0 w-full h-px bg-[#2a4f32]"></div>
          <div className="absolute top-3/4 left-0 w-full h-px bg-[#2a4f32]"></div>
        </div>
      </div>
